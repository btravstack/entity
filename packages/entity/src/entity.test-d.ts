...
test("factory generators are functions, and must cover exactly the generated fields", () => {
  ...
  class Org extends Entity("Org")({
    id: Entity.field(OrgId, { generated: true, immutable: true }),
    slug: Slug,
    createdAt: Entity.field(Instant, { generated: true }),
  }) {}
...
test("producers are castless: from and generators take the schema's input", () => {
  ...
  class Stamped extends Entity("Stamped")({
    id: Entity.field(StampId, { generated: true }),
    name: Slug,
  }) {}
  ...
  class Optional extends Entity("Optional")({
    id: StampId,
    theField: Entity.field(OptionalId.optional(), { generated: true }),
  }) {}
